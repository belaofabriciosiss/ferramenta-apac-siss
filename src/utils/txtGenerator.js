...
export function gerarLinha13(linhaExcel, numeroApac, cabecalho) {
  let linha = ''
  linha += '13' // Indicador 13
  linha += padNum(cabecalho.competencia, 6) // ANO/MÊS PRODUÇÃO
  linha += padNum(numeroApac, 13) // NÚMERO APAC
  linha += padNum(linhaExcel['PROCEDIMENTOS'], 10) // PROCEDIMENTOS
  linha += padNum(cabecalho.cboAutorizador, 6) // CBO (6)
  linha += padNum('1', 7) // Quantidade de procedimentos fixo 1
  ...
  linha += padText('', 4) // Area da Equipe
  return linha
}
