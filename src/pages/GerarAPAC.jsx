...
import { gerarLinha01, gerarLinha14, gerarLinha06, gerarLinhas13, getProcedimentos13Completo, normalizarProcedimento, getExtensaoMes, deveIncluirFixo0301, getProcFixo } from '../utils/txtGenerator'
  ...
  async function handleGerar() {
    ...
    try {
      ...
      for (const linhaExcel of planilha.dados) {
        ...
        // Linha 13 - proc fixo suplementar: código + qty real (omitido para APAC sem o fixo)
        if (deveIncluirFixo0301(proc14Norm)) {
          const procFixo = getProcFixo(proc14Norm)
          somaControle += BigInt(procFixo) + BigInt(qty0301)
        }
